                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h3 class="mb-0 fw-bold">{{ $stats['total_organizations'] }}</h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h3 class="mb-0 fw-bold">{{ $stats['active_organizations'] }}</h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h3 class="mb-0 fw-bold">{{ $stats['pending_organizations'] }}</h3>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-8">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            @if($admin)
                            <div class="row">
                                <div class="col-md-3 fw-bold text-muted">Ваш администратор:</div>
                                <div class="col-md-9">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-bottom d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge bg-success">{{ $organizations->count() }}</span>
                </div>
                <div class="card-body">
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3 py-3 border-bottom">
                        <div class="col-6">
                            <div class="text-center">
                                <div class="display-6 text-success mb-1">{{ $stats['active_organizations'] }}</div>
                                <small class="text-muted">Активных</small>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="text-center">
                                <div class="display-6 text-warning mb-1">{{ $stats['pending_organizations'] }}</div>
                    ...
                    <div class="pt-3">
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <span class="badge bg-secondary">{{ $stats['inactive_organizations'] ?? 0 }}</span>
                        </div>
                        <div class="d-flex justify-content-between">
                            <span class="text-muted">Истекших:</span>
                            <span class="badge bg-danger">{{ $stats['expired_organizations'] ?? 0 }}</span>
                        </div>
                    </div>

                    @if($stats['total_organizations'] > 0)
                        @php
                            $activePercentage = round(($stats['active_organizations'] / $stats['total_organizations']) * 100);
                        @endphp
                        <div class="mt-4">
